...
# Wallpaper
PRODUCT_COPY_FILES += \
    vendor/lineage/config/permissions/com.google.android.apps.wallpaper.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/com.google.android.apps.wallpaper.xml
